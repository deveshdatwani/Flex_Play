...
import register, hi, login, player_groups, create_group, group_home, add_player_to_group, remove_player_from_group, create_event, view_group_events, join_group_event
...
app.register_blueprint(join_group_event.bp)
